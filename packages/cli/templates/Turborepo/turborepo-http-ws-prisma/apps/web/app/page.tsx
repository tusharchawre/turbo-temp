  ...
  return (
    <div className="bg-black w-full h-screen overflow-hidden flex items-center justify-center text-white relative">
      <div className="absolute inset-0 overflow-hidden">
        <div className="w-[300px] h-[300px] bg-blue-500/30 rounded-full absolute top-1/4 left-[38%] blur-3xl animate-pulse -translate-x-16"></div>
        ...
        <div className="w-[150px] h-[150px] bg-pink-500/30 rounded-full absolute top-[35%] left-[55%] blur-3xl animate-pulse"></div>
      </div>
