export const Footer = () => {
  return (
    <div className="w-full h-64 border-t border-t-foreground/30 translate-y-4 px-12 py-8">
      <div className="w-full max-w-[1240px] flex items-start justify-between">
        <div>
          ...
          <p className="text-base text-foreground/40">
            Building in public{" "}
            <span className="text-[#0084FFC4] hover:text-[#0084ff96] cursor-pointer transition-all ease-in-out">
              @TusharCtwt
            </span>
          </p>
        </div>
